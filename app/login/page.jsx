        ...
        <div>
            ...
            <div className="background">
                ...
                <div className="flex justify-center items-center min-h-screen">
                    <div className="w-full max-w-lg mb-10 lg:max-w-xl xl:max-w-2xl bg-opacity-60 md:max-md:bg-black/60 bg-black/60 backdrop-blur- p-10 rounded-lg shadow-md md:w-[450px]">
